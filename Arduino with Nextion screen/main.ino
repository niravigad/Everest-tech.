...
pinMode(CH6_CNT_ON_OFF, OUTPUT);
pinMode(CH7_CNT_ON_OFF, OUTPUT);

pinMode(OVEN_5V, INPUT);
pinMode(PS_ON_OFF_ST, INPUT);
     ...
     while (Serial.available()) 
      ...
      if (MsgComplete) 
      {
        ...
        switch(ByteArray[Opcode])
        {
          ...
          break;
          case X_Relay:          
            //SetSwitch (ByteArray[Address],ByteArray[Value]);            
          break;          
          case X_Analog_Read:
